                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        if (isset($_POST["btn_submit"])) {
                                            ...
                                            if ($result->num_rows == 1 && $role_id == "2" && $_FILES["file_upload"]["error"] != 4) {
                                                ...
                                                $list_allow_extension = array("txt");
                                                if (!in_array($imageFileType, $list_allow_extension)) {
                                                    echo "Sorry, only [" . implode(", ", $list_allow_extension) . "] files are allowed.";
                                                    $upload_result = 0;
                                                }
                                                $sql = "INSERT INTO exercise (user_created, type_id, content, createdtime, file_name) "
                                                        . "VALUES ('$username', 2, '$description', '$time', '$file_name')";
                                                if ($upload_result == 1 && mysqli_query($conn, $sql)) {
                                                    ...
                                                    . 'setTimeout(function() { window.location.href = "view_challenge.php"; }, 2200);'
                                                    . ' </script>';
                                                } else {
                                        ...
                                        ob_end_flush();
                                        ?>
                                        <form method="POST" action="up_challenge.php" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            ...
                                            <div class="item form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 ">
                                                    ...
                                                    <label class="col-form-label col-md-13 col-sm-13" style="color: red">NOTE: Filename is written in Vietnamese without accents and words are separated by spaces </label>
                                                </div>
                                            </div>
