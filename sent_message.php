                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        if (isset($_POST["btn_submit"])) {
                                            ...
                                            $result = mysqli_query($conn, $sql);
                                            if ($result->num_rows == 1) {
                                                $column = "sent_user, recv_user, subject, createdtime, modifiedtime, enable";
                                                $value = "'$current_username', '$username', '$subject', '$time', '$time', 1";
                                                if ($message_content != "") {
                                                    $column .= ", content";
                                                    $value .= ", '$message_content'";
                                                }
                                                $sql = "INSERT INTO message ($column) VALUES ($value)";
                                                if (mysqli_query($conn, $sql)) {
                                                    echo '<script type="text/javascript"> '
                                                    . 'alertify.success(\'Sent message successfully\', 2);'
                                        ...
                                        ob_end_flush();
                                        ?>
                                        <form method="POST" action="sent_message.php?user=<?php echo $username; ?>" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="item form-group">
                                                <div class="col-md-6 col-sm-6 offset-md-3">
                                                    <button class="btn btn-success" name="btn_submit">Sent</button>
