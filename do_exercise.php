...
if (isset($_GET["id"])) {
    $id = $_GET["id"];
    $sql = "SELECT content, file_name FROM exercise WHERE id = $id AND type_id = 1";
    $result = mysqli_query($conn, $sql);
    if ($result->num_rows != 1) {
        header("Location: view_exercise.php");
        return;
    } else {
        $sql = "SELECT file_result FROM do_exercise WHERE exercise_id = $id AND user = '$current_username'";
                                ...
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        if (isset($_POST["btn_submit"])) {
                                            ...
                                            $result = mysqli_query($conn, $sql);
                                            if ($result->num_rows == 1 && $_FILES["file_upload"]["error"] != 4) {
                                                $upload_result = 1;
                                                $target_file = "";
                                                $target_dir = "uploads/students/";
                                                $file_submit = basename($_FILES["file_upload"]["name"]);
                                                $target_file = $target_dir . $file_submit;
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    $sql = "INSERT INTO do_exercise (exercise_id, user, file_result, createdtime)"
                                                            . " VALUES ($id, '$current_username', '$file_submit', '$time')";
                                                    if ($upload_result == 1 && mysqli_query($conn, $sql)) {
                                                        ...
                                                        echo '<script type="text/javascript"> '
                                                        . 'alertify.success(\'Submit exercise successfully\', 2);'
                                        ...
                                        ob_end_flush();
                                        ?>
                                        <form method="POST" action="do_exercise.php?id=<?php echo $id ?>" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">File exercise</label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="x_panel">
                                            ...
                                            <div class="item form-group">
                                                <label class="col-form-label col-md-3 col-sm-3 label-align">Submit Exercise </label>
                                                <div class="col-md-6 col-sm-6 ">
                                                    <div class="x_panel">
