                                            ...
                                            <table class="table table-striped jambo_table bulk_action">
                                                <thead>
                                                    <tr class="headings">
                                                        ...
                                                        <?php echo ($_SESSION['usertype'] == 2) ? '<th class="column-title">Filename</th>' : '' ?>
                                                        <?php echo ($_SESSION['usertype'] == 1) ? '<th class="column-title">Result</th>' : '' ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT * FROM exercise WHERE type_id = 2";
                                                    if ($role_id == 2) {
                                                    ...
                                                    if ($result->num_rows > 0) {
                                                        ...
                                                        while ($row = $result->fetch_assoc()) {
                                                            ...
                                                            if ($role_id == "1") {
                                                                $sql = "SELECT content FROM do_exercise WHERE exercise_id = $id AND user = '$username'";
                                                                $result_1 = mysqli_query($conn, $sql);
                                                                if ($result_1->num_rows == 1) {
                                                                    while ($row = $result_1->fetch_assoc()) {
                                                                        $ans_content = $row["content"];
                                                                        echo "<td class = \" \"><a href=\"uploads/teachers/$ans_content.txt\" download>$ans_content</a></td>";
                                                                        echo "<td class = \" \"></td>";
                                                                    }
                                                                } else {
                                                                    echo "<td class = \" \"></td>";
                                                                    echo "<td class=\" last\"><a href='do_challenge.php?id=$id'>Do Challenge</a></td>";
                                                                }
                                                            } else if ($role_id == "2") {
                                                                echo "<td class = \" \"><a href=\"uploads/teachers/$file_name\" download>$file_name</a></td>";
                                                                echo "<td class=\" last\"><a href='detail_challenge.php?id=$id'>View Detail</a></td>";
                                                            }
                                                            echo "</tr>";
                                                            $count += 1;
                                                        }
